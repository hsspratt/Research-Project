...
parameters_file = '/Users/jakehurley/Downloads/Parameters.csv';
...
GaAs_Data = '/Users/jakehurley/4th Year Project/GitHub Download/Automated Data/_21.03.22  13.00.57  20 ms 40/21.03.22  13.00.57  .txt';
num = importdata(GaAs_Data);

Transmission_data = '';
transdat = importdata(Transmission_data);
